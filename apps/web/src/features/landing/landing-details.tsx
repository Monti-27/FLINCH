...
export const questions = [
  { question: "Am I playing with real money?", answer: "No. FLINCH is an experimental test-token build. The public preview has transactions disabled; executable local testing requires the local stack. Public devnet gameplay is not deployed yet. Test SOL and test USDC have no monetary value." },
