...
export function AssetTicket({ label, detail, symbol, amount, precise = false, stacked = false, children }: {
  label: string; detail?: string; symbol: "SOL" | "WSOL" | "USDC"; amount: ReactNode; precise?: boolean; stacked?: boolean; children?: ReactNode;
}) {
